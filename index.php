...
<main>
  ...
  <div class="absolute top-20 left-1/2 transform -translate-x-1/2 z-10 text-center text-white px-4 sm:px-8 max-w-3xl animate-fade-in-down">
    <h1 class="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight drop-shadow-lg">
  ...
  <div class="absolute bottom-24 left-1/2 transform -translate-x-1/2 z-10 text-center px-6 md:px-12 max-w-2xl animate-fade-in-up">
    <p class="mb-6 text-lg md:text-xl font-light text-gray-200">Timeless, emotional, and authentic photography for your most important days.</p>
  ...
  <section class="bg-gray-50 py-20 px-6 text-center">
    <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-10">Featured Shots</h2>
    <div class="flex overflow-x-auto space-x-6 px-2 md:px-10 scrollbar-hide snap-x snap-mandatory">
      <?php
        ...
        foreach ($images as $img) {
          echo "<div class='flex-shrink-0 w-72 snap-start transform hover:scale-105 transition duration-300'>
                  <img src='assets/images/{$img}' alt='' class='h-52 w-full object-cover rounded-xl shadow-md'>
                </div>";
        }
      ?>
    </div>
  ...
  <section class="flex flex-wrap items-center justify-center gap-12 bg-white py-20 px-6 relative">
    ...
    <div class="flex-1 max-w-lg z-10">
      <h2 class="text-3xl font-bold mb-4 text-gray-900">Behind the Lens</h2>
  ...
  <section class="py-20 px-6 bg-white text-center">
    <h2 class="text-3xl font-bold text-gray-800 mb-12">Explore My Work</h2>
    <div class="flex flex-wrap justify-center gap-8">
      <?php
        ...
        foreach ($categories as $cat) {
          echo "<a href='portfolio.php#{$cat['slug']}' class='relative group w-72 h-48 rounded-xl overflow-hidden shadow-xl transform hover:scale-105 transition-all duration-300'>
